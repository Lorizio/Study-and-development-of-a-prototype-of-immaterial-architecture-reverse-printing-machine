...
one Arduino board which will start to produce foam, as well as a set of target positions for two step motors to another Arduino 
board to start cutting the sculpture.
	Foam producing does not depend on cutting algorithm for step motors thus can be explained separately here, whereas
